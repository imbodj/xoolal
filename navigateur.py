...
# Compteur d'onglets pour nommer les profils isolés
COMPTEUR_ONGLETS = 0
...
STYLE_CLAIR = """
    ...
    QComboBox QAbstractItemView {
        ...
        border: 2px solid #00853F; border-radius: 5px;
    }
    QTabBar::tab {
...
class Navigateur(QMainWindow):
    def __init__(self):
        ...
        self.setWindowIcon(QIcon("xoolal_icon.png"))
        ...
        # 🛡️ Dictionnaire profils isolés par onglet
        self.profils_onglets = {}
        self.setStyleSheet(STYLE_CLAIR)

        charger_liste_noire()

        # Profil partagé normal (si isolation désactivée)
        self.profil_normal = QWebEngineProfile.defaultProfile()
        # Profil privé partagé
        ...
        self.url_bar.setFixedWidth(420)
        ...
        self.menu.addAction("🔍 Infos isolation", self.infos_isolation)
        self.menu.addSeparator()
    ...
    def toggle_isolation(self):
        ...
        if ISOLATION_ACTIVE:
            ...
            QMessageBox.information(self, "Xoolal",
                "🛡️ Isolation activée !\n\n"
                "✅ Chaque onglet a ses propres cookies\n"
                "✅ Les sessions ne se mélangent pas\n"
                "✅ Un onglet piraté n'affecte pas les autres\n\n"
                "Les nouveaux onglets seront isolés.")
        else:
            ...
            QMessageBox.information(self, "Xoolal",
                ...
                "Les onglets partagent maintenant les mêmes cookies.")

    def infos_isolation(self):
        nb_profils = len(self.profils_onglets)
        QMessageBox.information(self, "🛡️ Isolation des Onglets",
            f"{'✅ ACTIVE' if ISOLATION_ACTIVE else '❌ DÉSACTIVÉE'}\n\n"
            f"📊 Profils isolés créés : {nb_profils}\n"
            f"🔒 Onglets actifs : {self.onglets.count()}\n\n"
            "🛡️ Ce que l'isolation protège :\n"
            "  • Les cookies ne se mélangent pas\n"
            "  • Tu peux te connecter à 2 comptes\n"
            "    différents sur le même site\n"
            "  • Un site espion dans un onglet ne\n"
            "    peut pas lire les autres onglets\n"
            "  • Protection contre les attaques\n"
            "    cross-site (CSRF, XSS)\n\n"
            "💡 Exemple : Onglet 1 = compte perso Gmail\n"
            "            Onglet 2 = compte pro Gmail"
        )
    ...
    def nouvel_onglet(self):
        ...
        # 🛡️ Chaque onglet obtient son propre profil
        ...
        # Stocker l'id d'onglet dans le browser
    ...
    def fermer_onglet(self, index=None):
        ...
        if self.onglets.count() > 1:
            ...
            # Nettoyer le profil isolé quand l'onglet se ferme
    ...
    def naviguer(self):
        ...
        if "." in texte and " " not in texte:
            ...
            url = get_url_recherche(texte)
            self.onglets.currentWidget().setUrl(QUrl(url))
    ...
    def toggle_bloqueur(self):
        ...
        if BLOQUEUR_ACTIF:
            self.action_bloqueur.setText("🚫✅ Bloqueur de pubs ON")
            QMessageBox.information(self, "Xoolal", "🚫 Bloqueur activé !")
        else:
            self.action_bloqueur.setText("🚫❌ Bloqueur de pubs OFF")
            QMessageBox.information(self, "Xoolal", "✅ Bloqueur désactivé.")
    ...
    def infos_page(self):
        ...
        QMessageBox.information(self, "📊 Infos sur la page",
            ...
            f"🔎 Zoom : {int(self.zoom_actuel * 100)}%\n"
            f"🚫 Pubs bloquées : {STATS_PUBS['bloquees']}\n"
